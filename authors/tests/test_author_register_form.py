...
class uthorRegisterFoArmUniTest(TestCase):
...
class uthorRegisterFoArmIntegrationTest(DjangoTesteCase):
    ...
    def test_password_and_password_confirmation_are_equals(self):
        self.form_data['password'] = '@A123abc123'
